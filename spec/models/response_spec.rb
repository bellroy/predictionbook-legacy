...
describe Response do
    ...
    describe 'wagers' do
      ...
      describe 'statistics' do
        it 'should have a "statistics" collection' do
          ...
          lambda {Response.wagers.statistics}.should_not raise_error(NoMethodError)
        end
  ...
  describe 'validations' do
    ...
    it 'should validate belong to a prediction' do
      ...
      response.should have(1).error_on(:prediction)
    end

    it 'should require a name' do
      response = valid_response(:user => nil)
      response.should have(1).error_on(:user)
    end
    
    it 'should not require a confidence' do
      response = valid_response(:confidence => nil)
      response.should have(:no).errors_on(:confidence)
    end
    ...
    it 'should require the confidence to be <= 100' do
      ...
      response.should have(1).error_on(:confidence)
    end
    ...
    it 'should have no error on prediction if prediciton has unknown outcome' do
      ...
      response.should have(:no).errors_on(:prediction)
    end
  ...
  describe 'comment?' do
    before(:each) do
      @response = Response.new(:comment => @comment = mock('comment'))    
    end
  ...
  describe 'comment' do
    ...
    describe 'when not nil' do
      ...
      it 'should respond to to_html' do
        @response.comment.respond_to?(:to_html).should be_true
      end
      describe 'action comment?' do
        it 'should be false if starts with /me but nothing else' do
          @response.comment = '/me      '
          @response.action_comment?.should be_false
        end
        ...
        it 'should be true if starts with /me and has other stuff' do
          ...
          @response.action_comment?.should be_true
        end
        describe 'is true' do
          before(:each) do
  ...
  describe 'agreement' do
    describe 'confidence is < 50' do
      it 'should not agree' do
        ...
        @response.agree?.should be_false
      end
    end
    describe 'confidence is > 50' do
      it 'should agree' do
        @response = Response.new(:confidence => 80)
        @response.agree?.should be_true
      end
    end
    describe 'confidence is 50' do
      it 'should agree' do
        Response.new(:confidence => 80).agree?.should be_true
      end
    end
    describe 'confidence is nil' do
      it 'should agree' do
        Response.new(:confidence => nil).agree?.should be_true
      end
    end
  end
